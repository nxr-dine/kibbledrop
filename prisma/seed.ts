  ...
  const products = await Promise.all([
    prisma.product.create({
      data: {
        ...
        description: "High-quality protein with wholesome grains for adult dogs. Made with real chicken as the first ingredient and fortified with essential vitamins and minerals.",
        price: 29.99,
        category: "Food",
        petType: "Dog",
    ...
    prisma.product.create({
      data: {
        ...
        description: "Wild-caught salmon with sweet potato for sensitive cats. Limited ingredient formula perfect for cats with food sensitivities.",
        price: 34.99,
        category: "Food",
        petType: "Cat",
    ...
    prisma.product.create({
      data: {
        ...
        description: "Specially formulated nutrition for growing puppies. Contains DHA for brain development and calcium for strong bones.",
        price: 32.99,
        category: "Food",
        petType: "Dog",
    ...
    prisma.product.create({
      data: {
        ...
        description: "Easy-to-digest formula for senior cats. Lower calorie content with added glucosamine for joint health.",
        price: 31.99,
        category: "Food",
        petType: "Cat",
    ...
    prisma.product.create({
      data: {
        ...
        description: "Balanced nutrition for large breed dogs. Controlled calcium and phosphorus levels for healthy bone development.",
        price: 39.99,
        category: "Food",
        petType: "Dog",
    ...
    prisma.product.create({
      data: {
        ...
        description: "Lower calorie formula for indoor cats. High fiber content to help with hairball control.",
        price: 28.99,
        category: "Food",
        petType: "Cat",
    ...
    prisma.product.create({
      data: {
        ...
        description: "Natural peanut butter treats for training and rewards. Made with real peanut butter and no artificial preservatives.",
        price: 12.99,
        category: "Treats",
        petType: "Dog",
    ...
    prisma.product.create({
      data: {
        ...
        description: "Grain-free tuna treats for cats. High in protein and perfect for training or as a special reward.",
        price: 9.99,
        category: "Treats",
        petType: "Cat",
    ...
    prisma.product.create({
      data: {
        ...
        description: "Comfortable and durable nylon collar with quick-release buckle. Available in multiple sizes and colors.",
        price: 19.99,
    ...
    prisma.product.create({
      data: {
        ...
        description: "Multi-level cat tree with sisal scratching posts and comfortable perches. Perfect for indoor cats.",
        price: 89.99,
        category: "Accessories",
        petType: "Cat",
    ...
    prisma.product.create({
      data: {
        ...
        description: "15-foot retractable leash with ergonomic handle and safety lock. Perfect for walks and training.",
        price: 24.99,
        category: "Accessories",
        petType: "Dog",
    ...
    prisma.product.create({
      data: {
        ...
        description: "Automatic self-cleaning litter box with odor control. Reduces maintenance and keeps your home fresh.",
        price: 199.99,
        category: "Accessories",
        petType: "Cat",
