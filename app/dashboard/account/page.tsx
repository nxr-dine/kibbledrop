                ...
                <div className="flex items-center gap-6">
                  <div className="relative">
                    <Avatar className="h-32 w-32 border-4 border-white shadow-lg">
                      ...
                      <AvatarFallback className="text-3xl font-bold bg-white text-orange-600">
                  ...
                  <div className="flex-1">
                                         <h2 className="text-3xl font-bold mb-2">{userProfile?.name || user?.name || "User"}</h2>
                     <p className="text-orange-100 text-lg mb-3">{userProfile?.email || user?.email}</p>
                     ...
                     <div className="space-y-3">
                       <Label htmlFor="name" className="text-sm font-semibold text-gray-700">
                         Full Name
                          ...
                          <div className="h-12 px-4 bg-gray-50 rounded-md flex items-center border border-gray-200">
