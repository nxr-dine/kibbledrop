  ...
  const handleModifyItems = async (subscriptionId: string) => {
    try {
      const response = await fetch(
        `/api/subscription/${subscriptionId}/items`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
      ...
      if (response.ok) {
        ...
        toast({
          title: "Items Updated",
          description:
            "Your subscription items have been updated successfully.",
        });
      } else {
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
        ...
        <>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2 text-sm text-orange-600 bg-orange-50 p-3 rounded-lg">
                          ...
                          <span>
                            This subscription is waiting for payment to be
                            activated.
                          </span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2 pt-2">
                          ...
                          >
                            <CreditCard className="h-4 w-4 mr-2" /> Complete
                            Payment & Activate
                          </Button>
                          <Button
                            variant="destructive"
          ...
          <div className="mb-12">
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-6">
              Your Active & Paused Subscriptions
            </h2>
              ...
              <Card>
                <CardContent className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    You don't have any active or paused subscriptions.
                  </p>
                  <Button asChild>
                  ...
                  >
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        {subscription.skippedDeliveries &&
                          subscription.skippedDeliveries.length > 0 && (
                            <div className="text-sm text-gray-500">
                              Skipped deliveries:{" "}
                              {subscription.skippedDeliveries.length}
                            </div>
                          )}
                        ...
                        <div className="flex flex-wrap gap-2 pt-2">
                          <Dialog
                            open={modifyItemsOpen}
                            onOpenChange={setModifyItemsOpen}
                          >
                          ...
                          <Dialog>
                            <DialogTrigger asChild>
                              ...
                              >
                                <CalendarDays className="h-4 w-4 mr-2" /> Change
                                Date
                              </Button>
                            </DialogTrigger>
                            <DialogContent>
                              ...
                              <div className="space-y-4">
                                ...
                                <Button
                                  onClick={() =>
                                    handleCustomDeliveryDate(subscription.id)
                                  }
                                  className="w-full"
                                >
                          ...
                          {subscription.status === "active" ? (
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleUpdateStatus(subscription.id, "paused")
                              }
                            >
              ...
              <div className="space-y-4">
                ...
                <Button
                  onClick={() =>
                    ...
                    handleModifyItems(selectedSubscription.id)
                  }
                  className="w-full"
                >
                  Update Items
