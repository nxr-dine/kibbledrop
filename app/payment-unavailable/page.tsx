    ...
    try {
      ...
      if (pendingSubscription) {
        ...
        if (response.ok) {
          ...
          router.push('/dashboard/subscription/manage?created=true&payment=pending');
        } else {
        ...
        <CardContent className="space-y-6">
          <div className="bg-orange-50 p-4 rounded-lg">
            ...
            <p className="text-sm text-orange-800">
              Our payment gateway is temporarily unavailable. This may be due to maintenance 
              or technical issues. We apologize for the inconvenience.
            </p>
          </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="space-y-2 text-sm text-blue-800">
              <p><strong>Option 1:</strong> Continue and pay later through your subscription dashboard</p>
              <p><strong>Option 2:</strong> Go back and try again in a few minutes</p>
            </div>
          </div>
          ...
          <div className="text-xs text-gray-500 text-center">
            If you continue, you can complete payment later through your subscription dashboard.
          </div>
        </CardContent>
      </Card>
    </div>
